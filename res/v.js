...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_13_4_0_vue_loader_lib_template_compiler_index_id_data_v_32546946_hasScoped_true_buble_transforms_node_modules_13_4_0_vue_loader_lib_selector_type_template_index_0_MusicBar_vue__ = __webpack_require__(22);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-32546946"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_13_4_0_vue_loader_lib_template_compiler_index_id_data_v_32546946_hasScoped_true_buble_transforms_node_modules_13_4_0_vue_loader_lib_selector_type_template_index_0_MusicBar_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("0e4b13d0", content, true);
...
// module
exports.push([module.i, ".box-small[data-v-32546946]{margin:.6em .3em;background-color:#fff;box-shadow:.2em .2em .4em #c5c5c5}.box-big[data-v-32546946]{margin:.3em 0;padding:0;background-color:#fff;border-radius:.35em;box-shadow:.25em .25em .5em #c5c5c5}.cover-small[data-v-32546946]{position:relative;margin-bottom:-.3em;overflow:hidden}.cover-big[data-v-32546946]{position:relative;width:100%;overflow:hidden}.icon-play[data-v-32546946]{position:absolute;right:.1em;bottom:.25em;width:50%;color:hsla(0,0%,100%,.9)}.icon-playing[data-v-32546946]{position:absolute;right:.1em;bottom:.1em}.info-bar-small[data-v-32546946]{padding:0 1em}.info-bar-big[data-v-32546946]{padding:.5em;height:7em}.song-name[data-v-32546946]{font-weight:bolder;font-size:1.1em}.img-cover[data-v-32546946]{width:100%;transform:scale(1);-webkit-transition:transform 1s;-ms-transition:transform 1s;-moz-transition:transform 1s;-o-transition:transform 1s;transition:transform 1s}.img-cover[data-v-32546946]:hover{transform:scale(1.25)}", ""]);
